...
<script type="text/javascript">
 ...
 // 벽돌 설정
                ...
                if (b.status == 1) {
                    if (
                        ...
                        if (score == brickRowCount * brickColumnCount) {
                            alert("당신은 최후의 환상을 이겨냈습니다... 엔딩 크래딧으로 이동합니다.");
                            window.location.href = "successGOD.jsp";
                        }
                    }
                }
            }
    ...
    function draw() {
        ...
        backgroundImage.src = 'images/map1.jpg'; // 배경 이미지의 경로를 설정합니다.
        drawBricks();
        drawBall();
        drawPaddle();
        drawScore();
